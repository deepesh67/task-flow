...
import { TrendingUp, Circle, CheckCircle, Clock, Zap } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="ml-0 xl:ml-64 lg:ml-64 md:ml-16 pt-16 p-3 sm:p-4 md:p-4 transition-all duration-300">
        {isAdmin ? (
          // Admin — full width, no right sidebar
          <div className="max-w-6xl mx-auto">
            <Outlet context={{ tasks, refreshTasks: fetchTasks, setUser }} />
          </div>
        ) : (
          // Employee — original layout with right sidebar
            ...
            <div className="xl:col-span-1 space-y-4 sm:space-y-6">
              <div className="bg-white rounded-xl p-4 sm:p-5 shadow-sm border border-purple-100">
                ...
                <div className="grid grid-cols-2 gap-3 sm:gap-4 mb-4 sm:mb-6">
                  ...
                  <StatCard title="Pending" value={stats.pendingCount} icon={<Clock className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-fuchsia-500" />} />
